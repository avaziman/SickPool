...
//     LYRA2((void*)&hash[19], 32, (const void*)&hash[18], 32,
...
// #define X25X_SHUFFLE_BLOCKS                                             \
//     (24 /* number of algos so far */ * 64 /* output bytes per algo */ / \
//      2 /* block size */)
// #define X25X_SHUFFLE_ROUNDS 12

//     static const uint16_t x25x_round_const[X25X_SHUFFLE_ROUNDS] = {
//         0x142c, 0x5830, 0x678c, 0xe08c, 0x3c67, 0xd50d,
//         0xb1d8, 0xecb2, 0xd7ee, 0x6783, 0xfa6c, 0x4b9c};
...
//             block_pointer[i] ^=
//                 block_pointer[block_value % X25X_SHUFFLE_BLOCKS] +
...
void x22i_hash(uint8_t* output, const uint8_t* input)
{
    ...
    memset(hash, 0, 64);
    LYRA2((void*)hash, 32, (const void*)hash2, 32, (const void*)hash2, 32, 1, 4,
          4);
