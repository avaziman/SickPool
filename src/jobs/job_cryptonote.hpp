...
struct BlockTemplateCryptoNote
{
...
class JobCryptoNote : public Job
{
   public:
    JobCryptoNote(const std::string& jobId,
                  const BlockTemplateCryptoNote& bTemplate, bool is_payment,
                  bool clean = true)
